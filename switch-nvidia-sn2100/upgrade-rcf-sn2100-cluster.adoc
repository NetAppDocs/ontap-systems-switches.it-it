...
---
= Aggiornare lo script RCF (Reference Configuration file)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Seguire questa procedura per aggiornare lo script RCF.

.Prima di iniziare
Prima di aggiornare lo script RCF, assicurarsi che sullo switch siano disponibili le seguenti opzioni:
