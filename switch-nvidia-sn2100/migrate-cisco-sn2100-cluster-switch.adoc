...
[role="lead"]
Esegui la migrazione dagli switch di cluster Cisco agli switch di cluster NVIDIA SN2100 senza interrompere il funzionamento del cluster.
...
È necessario essere a conoscenza di alcune informazioni di configurazione, connessioni delle porte e requisiti di cablaggio quando si sostituiscono alcuni vecchi switch cluster Cisco con switch cluster NVIDIA SN2100. Fare riferimento a link:configure-overview-sn2100-cluster.html["Panoramica dell'installazione e della configurazione degli switch NVIDIA SN2100"].
...
Per i dettagli sulle porte supportate e le relative configurazioni, fare riferimento a link:https://hwu.netapp.com/["Hardware Universe"^] .
...
NOTE: Se si modifica la velocità delle porte cluster e0a ed e1a sui sistemi AFF A800 o AFF C800, è possibile che vengano ricevuti pacchetti non validi dopo la conversione della velocità. Fare riferimento a link:https://mysupport.netapp.com/site/bugs-online/product/ONTAP/BURT/1570339["Errore 1570339"^] e all'articolo della Knowledge Base link:https://kb.netapp.com/onprem/ontap/hardware/CRC_errors_on_T6_ports_after_converting_from_40GbE_to_100GbE["Errori CRC sulle porte T6 dopo la conversione da 40 GbE a 100 GbE"^] per indicazioni.
