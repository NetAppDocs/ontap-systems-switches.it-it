...
IMPORTANT: Consultare link:cabling-considerations-sn2100-cluster.html["Rivedi le linee guida per il cablaggio e la configurazione"] per avvertenze e ulteriori dettagli. Il link:https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe - Interruttori"^] contiene anche maggiori informazioni sul cablaggio.
