...
summary: Migra gli switch cluster CN1610 NetApp esistenti agli switch cluster NVIDIA SN2100 senza interrompere il funzionamento del cluster. 
---
= Migra dagli switch di cluster NetApp CN1610 agli switch di cluster NVIDIA SN2100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Migra gli switch cluster CN1610 NetApp esistenti agli switch cluster NVIDIA SN2100 senza interrompere il funzionamento del cluster.
