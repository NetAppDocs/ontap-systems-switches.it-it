...
summary: Ripristina lo switch cluster NVIDIA SN2100 alle impostazioni di fabbrica cancellando la configurazione corrente dello switch. 
---
= Ripristina lo switch cluster NVIDIA SN2100 alle impostazioni di fabbrica
:allow-uri-read: 


[role="lead"]
Ripristina lo switch cluster NVIDIA SN2100 alle impostazioni di fabbrica cancellando la configurazione corrente dello switch e ripristinando le impostazioni originali.
...
NOTE: Per ulteriori informazioni sull'installazione di Cumulus Linux, fare riferimento a link:configure-software-overview-sn2100-cluster.html["Flusso di lavoro di installazione del software per gli switch NVIDIA SN2100"].
...
Consultare la documentazione link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-511/Installation-Management/Factory-Reset/["Ripristino delle impostazioni di fabbrica"^] NVIDIA per ulteriori dettagli.

--
====
.Cosa c'è dopo?
Dopo aver ripristinato gli switch, puoilink:configure-overview-sn2100-cluster.html["riconfigurare"] secondo necessità.
