...
summary: Esegui la migrazione dai vecchi switch di storage Cisco agli switch di storage NVIDIA SN2100 senza interrompere il funzionamento della rete di storage. 
---
= Esegui la migrazione da uno switch di storage Cisco a uno switch di storage NVIDIA SN2100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Esegui la migrazione dai vecchi switch di storage Cisco agli switch di storage NVIDIA SN2100 senza interrompere il funzionamento della rete di storage.
...
Per i dettagli sulle porte supportate e le relative configurazioni, fare riferimento alla link:https://hwu.netapp.com/["Hardware Universe"^].
