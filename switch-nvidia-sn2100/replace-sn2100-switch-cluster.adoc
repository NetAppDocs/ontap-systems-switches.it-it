...
summary: Sostituisci uno switch di cluster NVIDIA SN2100 difettoso in una rete di cluster. Questa è una procedura senza interruzioni. 
---
= Sostituisci uno switch di cluster NVIDIA SN2100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci uno switch di cluster NVIDIA SN2100 difettoso in una rete di cluster senza interrompere il funzionamento del cluster. Questa procedura non distruttiva (NDU) prevede la preparazione di uno switch sostitutivo e la migrazione delle connessioni dallo switch guasto.
