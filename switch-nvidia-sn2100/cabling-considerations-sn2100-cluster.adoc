...
Dopo aver esaminato i requisiti di cablaggio e configurazione, link:install-cable-shelves-sn2100-cluster.html["cablare i ripiani NS224 come spazio di archiviazione collegato all'interruttore"].
