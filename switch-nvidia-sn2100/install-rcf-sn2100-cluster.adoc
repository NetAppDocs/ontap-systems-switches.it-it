...
Sono disponibili due script RCF per le applicazioni cluster e storage. Scaricare gli RCF da https://mysupport.netapp.com/site/info/nvidia-cluster-switch["qui"^]. La procedura per ciascuno di essi è la stessa.
...
. Applicare lo script python RCF *MSN2100-RCF-v1.x-Cluster-ha-Breakout-LLDP*.
+
[listing, subs="+quotes"]
----
...
link:install-snmpv3-sn2100-cluster.html["Configurare la raccolta dei log degli switch"].
