...
summary: Assicurarsi che quanto segue sia disponibile sullo switch prima di installare lo script RCF 
---
= Installa o aggiorna lo script del file di configurazione di riferimento (RCF)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
