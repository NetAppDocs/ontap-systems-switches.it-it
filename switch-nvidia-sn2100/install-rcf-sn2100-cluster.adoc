...
. Riapplica alla configurazione dello switch tutte le personalizzazioni precedenti. Consulta link:cabling-considerations-sn2100-cluster.html["Rivedi le linee guida per il cablaggio e la configurazione"] per i dettagli su eventuali ulteriori modifiche necessarie.
