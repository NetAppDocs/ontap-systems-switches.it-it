...
NOTE: Nel passaggio 3 *Aggiornamento del file MOTD* sopra, il comando  `cat /etc/issue.net` è in esecuzione. Questo consente di verificare il nome file RCF, la versione RCF, le porte da utilizzare e altre informazioni importanti nel banner RCF.
...
NOTE: Nel passaggio 3 *Aggiornamento del file MOTD* sopra riportato, viene eseguito il comando `cat /etc/issue.net. Questo consente di verificare il nome file RCF, la versione RCF, le porte da utilizzare e altre informazioni importanti nel banner RCF.
