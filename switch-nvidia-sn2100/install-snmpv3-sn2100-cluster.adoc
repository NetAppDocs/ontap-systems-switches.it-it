...
---
= Configurare SNMPv3 per la raccolta dei log dello switch
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Seguire questa procedura per configurare SNMPv3, che supporta la raccolta dei log dello switch e Switch Health Monitoring (SHM).
...
----
====
. Configurare il modulo SHM per il monitoraggio con il nuovo utente SNMPv3:
+
...
----
====
. Verificare che il numero di serie da interrogare con l'utente SNMPv3 appena creato sia lo stesso descritto nel passaggio precedente una volta completato il periodo di polling di SHM.
+
