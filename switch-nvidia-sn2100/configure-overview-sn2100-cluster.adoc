...
summary: Segui questo workflow per installare e configurare gli switch cluster NVIDIA SN2100 in un ambiente ONTAP. 
---
= Flusso di lavoro per l'installazione e la configurazione degli switch cluster NVIDIA SN2100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Segui questo flusso di lavoro per installare e configurare gli switch cluster NVIDIA SN2100 in un ambiente ONTAP. L'SN2100 è uno switch 10/25/40/100 GbE con sistema operativo Cumulus Linux che supporta cluster ONTAP con più di due nodi.

Segui questi passaggi del flusso di lavoro per installare e configurare i tuoi switch NVIDIA SN2100.
