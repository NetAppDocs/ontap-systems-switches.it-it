...
summary: Lo switch NVIDIA SN2100 è uno switch Ethernet 10/25/40/100 GbE che esegue Cumulus Linux.  Lo switch SN2100 supporta applicazioni Cluster e Storage in ONTAP 9.10.1 su diverse coppie di switch. 
---
