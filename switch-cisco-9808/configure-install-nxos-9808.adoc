...
summary: Installa NX-OS sugli switch Cisco Nexus 9808 per nuove installazioni di sistemi AFX 2K, sostituzioni di moduli supervisor o ripristini delle impostazioni di fabbrica. 
---
= Installa NX-OS sullo switch Cisco Nexus 9808
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa NX-OS sugli switch Cisco Nexus 9808 per nuove installazioni di sistemi AFX 2K, sostituzioni di moduli supervisor o quando ripristini uno switch alle impostazioni di fabbrica.
