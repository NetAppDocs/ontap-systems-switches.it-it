...
summary: 'Aggiorna l"RCF sugli switch Cisco Nexus 9808 per supportare nuovo hardware, una nuova versione di ONTAP o una nuova versione di NX-OS sui sistemi AFX 2K.' 
---
= Aggiorna l'RCF sullo switch Cisco Nexus 9808
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiorna il file di configurazione (RCF) sugli switch Cisco Nexus 9808 per supportare nuovo hardware, una nuova versione di ONTAP o una nuova versione di NX-OS sui sistemi AFX 2K.
