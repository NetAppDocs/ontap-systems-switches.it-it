...
summary: Aggiorna NX-OS sugli switch Cisco Nexus 9808 per supportare nuovo hardware o una nuova versione di ONTAP sui sistemi AFX 2K. 
---
= Aggiorna NX-OS sullo switch Cisco Nexus 9808
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiorna NX-OS sugli switch Cisco Nexus 9808 per supportare nuovo hardware o una nuova versione di ONTAP sui sistemi AFX 2K.
