...
summary: Se si dispone di un ambiente cluster switchless a due nodi esistente, è possibile migrare a un ambiente cluster switched a due nodi utilizzando gli switch Cisco Nexus 9364d-gx2a per poter scalare oltre due nodi nel cluster. 
---
...
[role="lead"]
Se si dispone di un ambiente cluster a due nodi _senza switch_, è possibile migrare a un ambiente cluster a due nodi _con switch_ utilizzando gli switch Cisco Nexus 9364D-GX2A.
...
** Consultare la link:https://hwu.netapp.com["Hardware Universe"^] per tutte le versioni ONTAP supportate.
...
+
Consultare la link:https://hwu.netapp.com["Hardware Universe"^] per ulteriori informazioni sul cablaggio.
...
Consultare la link:https://hwu.netapp.com["Hardware Universe"^] per informazioni sulle porte del cluster per le proprie piattaforme.
