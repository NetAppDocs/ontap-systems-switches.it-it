...
.. Per NX-OS 10.2 e versioni successive utilizzare `show diff running-config` comando per confrontare con il file RCF salvato nel bootflash.  In caso contrario, utilizzare uno strumento di confronto/differenza di terze parti.
