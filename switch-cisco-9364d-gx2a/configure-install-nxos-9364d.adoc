...
summary: 'Installi NX-OS sul tuo switch Cisco Nexus 9364D-GX2A come parte dell"installazione di un nuovo sistema AFX 1K o AFX 2K, della sostituzione di uno switch o del ripristino dello switch alle impostazioni di fabbrica predefinite.' 
---
= Installa NX-OS - Cisco Nexus 9364D-GX2A
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installi NX-OS sul tuo switch Cisco Nexus 9364D-GX2A come parte dell'installazione di un nuovo sistema AFX 1K o AFX 2K, della sostituzione di uno switch o del ripristino dello switch alle impostazioni di fabbrica predefinite.
...
+
** Se il/i tuo/i switch hanno la versione corrente supportata da NetApp, non devi installare NX-OS. Devi installare l'RCF. Inizia con il link:configure-install-upgrade-rcf-overview-9364d.html["Installa o aggiorna la panoramica RCF"].
...
.Cosa succederà ora?
Dopo aver installato NX-OS sullo/sui tuoi switch, installi RCF iniziando con il link:configure-install-upgrade-rcf-overview-9364d.html["Installa o aggiorna la panoramica RCF"].
