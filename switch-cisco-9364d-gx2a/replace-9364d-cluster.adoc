...
summary: Sostituisci uno switch Cisco Nexus 9364D-GX2A difettoso in un sistema AFX senza interrompere il funzionamento. Questa è una procedura senza interruzioni. 
---
= Sostituisci uno switch Cisco Nexus 9364D-GX2A in un sistema AFX
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci uno switch Cisco Nexus 9364D-GX2A difettoso in un sistema AFX senza interrompere il funzionamento. Questa procedura non distruttiva (NDU) prevede la preparazione di uno switch sostitutivo e il ripristino della configurazione del sistema.
...
** La personalizzazione iniziale dello switch è completa, come descritto in dettaglio in link:configure-complete-initial-setup-9364d.html["Completa la configurazione iniziale dello switch"].
+
...
----
====
. Attiva tutte le porte dello switch newcs2.
+
.Mostra esempio
[%collapsible]
====
