...
* Completare la procedura inlink:install-nxos-overview-9364d-cluster.html["Prepararsi all'installazione di NX-OS e RCF"] .
...
.Cosa succederà ora?
Dopo aver installato o aggiornato il software NX-OS, è possibile link:install-upgrade-rcf-overview-cluster-9364d.html["installare o aggiornare il file di configurazione di riferimento (RCF)"].
