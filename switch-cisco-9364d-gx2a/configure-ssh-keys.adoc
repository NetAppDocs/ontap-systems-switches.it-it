...
summary: 'SSH è un requisito quando si utilizzano le funzionalità Cluster Switch Health Monitor (CSHM) e di raccolta dei log. Per abilitare SSH sugli switch di cluster Cisco 9364d-gx2a, è necessario prima generare le chiavi SSH e poi abilitare SSH.' 
---
