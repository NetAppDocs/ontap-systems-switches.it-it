...
summary: Migra un cluster senza switch a due nodi esistente a un ambiente cluster con switch utilizzando gli switch cluster Cisco Nexus 92300YC. 
---
= Migra a un cluster a due nodi con switch di cluster Cisco Nexus 92300YC
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Migra un cluster senza switch a due nodi esistente a un ambiente cluster con switch utilizzando gli switch cluster Cisco Nexus 92300YC. Questa migrazione senza interruzioni ti permette di scalare il cluster oltre i due nodi.
