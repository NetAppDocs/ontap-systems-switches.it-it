...
summary: Verifica che SSH e le chiavi SSH siano abilitati sugli switch di cluster Cisco Nexus 92300YC per supportare CSHM e la raccolta dei log. 
---
= Verifica la configurazione SSH per gli switch cluster Cisco Nexus 92300YC
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verifica che SSH e le chiavi SSH siano abilitati sugli switch cluster Cisco Nexus 92300YC per supportare le funzionalità di monitoraggio dello stato degli switch Ethernet (CSHM) e la raccolta dei log.
