...
summary: SSH è un requisito quando si utilizzano le funzionalità di Cluster Switch Health Monitor e raccolta dei log. Per abilitare SSH sugli switch di cluster Cisco 92300YC, è necessario prima generare le chiavi SSH e poi abilitare SSH. 
---
