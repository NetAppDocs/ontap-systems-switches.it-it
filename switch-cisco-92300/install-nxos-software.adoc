...
summary: Installa il software NX-OS sugli switch di cluster Cisco Nexus 92300YC per prepararli al funzionamento in cluster. 
---
= Installa il software NX-OS sugli switch di cluster Cisco Nexus 92300YC
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa il software NX-OS sugli switch di cluster Cisco Nexus 92300YC per prepararli al funzionamento in cluster. NX-OS deve essere installato prima che tu possa configurare lo switch o installare l'RCF.

NX-OS è un sistema operativo di rete per gli switch Ethernet della serie Nexus e per gli switch di rete di archiviazione Fibre Channel (FC) della serie MDS forniti da Cisco Systems.
...
* Software Cisco NX-OS NetApp applicabile per i tuoi switch dal NetApp Support Site, disponibile da http://mysupport.netapp.com/["mysupport.netapp.com"]
* Un cluster completamente funzionante (nessun errore nei log o problemi simili).
* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Pagina dello switch Ethernet Cisco"^]. Consultare la tabella di compatibilità dello switch per le versioni ONTAP e NX-OS supportate.
...
Gli esempi in questa procedura utilizzano due nodi, ma puoi avere fino a 24 nodi in un cluster.
...
.Cosa succederà ora?
Dopo aver installato il software NX-OS, puoi link:install-the-rcf-file.html["installare l'RCF"].
