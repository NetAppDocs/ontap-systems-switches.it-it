...
summary: Puoi usare questa procedura per installare il software NX-OS sullo switch Nexus 92300YC. 
---
...
[role="lead"]
Segui questa procedura per installare il software NX-OS sullo switch Nexus 92300YC.
