...
summary: Puoi installare lo switch Cisco Nexus 92300YC e il pannello passante in un armadio NetApp utilizzando le staffe standard incluse con lo switch. 
---
= Installa uno switch di cluster Cisco Nexus 92300YC in un armadio NetApp
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A seconda della configurazione, potresti dover installare lo switch di cluster Cisco Nexus 92300YC e il pannello pass-through in un armadio NetApp utilizzando le staffe standard incluse con lo switch.

.Prima di iniziare
* I requisiti di preparazione iniziale, il contenuto del kit e le precauzioni di sicurezza nel link:https://www.cisco.com/site/us/en/products/networking/cloud-networking-switches/nexus-9200-series-switches/index.html["Guida all'installazione dell'hardware Cisco Nexus serie 9000"^].
* Per ogni switch, sono necessarie otto viti 10-32 o 12-24 e dadi a clip per montare le staffe e le guide scorrevoli sui montanti anteriori e posteriori del cabinet.
...
. Installa le staffe per il montaggio a rack sullo chassis dello switch Nexus 92300YC.
+
...
+
I due switch 92300YC saranno sempre montati nei primi 2U in alto degli armadi RU41 e 42.
...
+
_(1) Facendo scorrere delicatamente la guida, allineala ai fori delle viti nel rack._ + _(2) Stringi le viti delle guide ai montanti dell'armadio._
...
====
. Collega la porta di gestione di ogni switch 92300YC a uno degli switch di gestione (se ordinati) oppure collegali direttamente alla tua rete di gestione.
+
...
.Cosa c'è dopo?
Dopo aver installato gli switch nel cabinet NetApp, puoi link:configure-install-initial.html["configurare lo switch"].
