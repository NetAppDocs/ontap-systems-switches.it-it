...
summary: La sostituzione di uno switch Nexus 92300YC difettoso in una rete cluster è una procedura non distruttiva. 
---
...
[role="lead"]
La sostituzione di uno switch Nexus 92300YC difettoso in una rete cluster è una procedura non disruptive (NDU).
