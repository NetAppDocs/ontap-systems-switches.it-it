...
Per configurare gli switch Cisco Nexus 92300YC, è necessaria la seguente documentazione dal https://www.cisco.com/site/us/en/products/networking/cloud-networking-switches/nexus-9200-series-switches/index.html["Supporto degli switch Cisco Nexus serie 9000"^] pagina:
