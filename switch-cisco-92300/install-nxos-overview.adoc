...
summary: Il software Cisco NX-OS e i file di configurazione di riferimento devono essere installati sugli switch cluster Cisco Nexus 92300YC. 
---
= Preparati a installare il software NX-OS e il Reference Configuration File (RCF)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
