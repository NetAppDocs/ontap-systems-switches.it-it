...
summary: 'Il software Cisco NX-OS e i file di configurazione di riferimento (RCF) devono essere installati sugli switch di cluster Cisco Nexus 92300YC.' 
---
...
.Cosa succederà ora?
Dopo esserti preparato per installare il software NX-OS e RCF, puoi link:install-nxos-software.html["installare il software NX-OS"].
