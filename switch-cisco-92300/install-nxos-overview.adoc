...
summary: 'Prepara gli switch cluster Cisco Nexus 92300YC prima di installare il software NX-OS e il file di configurazione (RCF).' 
---
= Preparati a installare il software NX-OS e l'RCF sugli switch di cluster Cisco Nexus 92300YC
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prepara gli switch cluster Cisco Nexus 92300YC prima di installare il software NX-OS e il file di configurazione (RCF). NX-OS e l'RCF devono essere installati prima che lo switch possa operare in un cluster ONTAP.

.Prima di iniziare
Assicurati di avere quanto segue:

* Un cluster completamente funzionante (nessun errore nei log o problemi simili).
* Software appropriato e guide di aggiornamento, disponibili da  https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html#InstallandUpgrade["Switch Cisco Nexus serie 9000"^].
...
La procedura richiede l'utilizzo sia dei comandi ONTAP che dei comandi degli switch Cisco Nexus 9000 Series; vengono utilizzati i comandi ONTAP, salvo diversa indicazione. L'output dei comandi può variare a seconda delle diverse release di ONTAP.
...
----
. Visualizza quante interfacce di interconnessione del cluster sono configurate in ciascun nodo per ogni switch di interconnessione del cluster: `network device-discovery show -protocol cdp`
+
.Mostra esempio
[%collapsible]
====
...
----
====
.. Visualizza le informazioni sui LIF: `network interface show -vserver Cluster`
+
.Mostra esempio
[%collapsible]
====
...
.Cosa succederà ora?
Dopo aver preparato l'installazione del software NX-OS e RCF, puoi link:install-nxos-software.html["installare il software NX-OS"].
