...
summary: 'Puoi installare l"RCF dopo aver configurato per la prima volta lo switch Nexus 92300YC.' 
---
...
[role="lead"]
Puoi installare l'RCF dopo aver configurato per la prima volta lo switch Nexus 92300YC. Puoi anche usare questa procedura per aggiornare la versione dell'RCF.
