...
summary: Questa versione include il supporto per SNMPv3 per il monitoraggio dei log. 
---
= Configurare SNMPv3 per la raccolta dei registri dello switch
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Seguire questa procedura per configurare SNMPv3, che supporta la raccolta dei registri degli switch e il monitoraggio dello stato dello switch (SHM).
...
Il seguente comando stabilisce il nome utente SNMPv3 con SHM:
