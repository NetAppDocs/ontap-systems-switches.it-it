...
summary: 'Configura SNMPv3 sugli switch di storage NVIDIA SN2100 per abilitare la raccolta sicura dei log dello switch e l"health monitoring.' 
---
= Configura SNMPv3 per gli switch di storage NVIDIA SN2100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Configura SNMPv3 sugli switch di storage NVIDIA SN2100 per abilitare la raccolta sicura e autenticata dei log dello switch e l'Ethernet switch health monitor (CSHM).
...
----
====
. Configurare SHM per il monitoraggio con il nuovo utente SNMPv3:
+
...
----
====
. Verificare che il numero di serie da interrogare con l'utente SNMPv3 appena creato sia lo stesso specificato nel passaggio precedente una volta completato il periodo di polling SHM.
+
