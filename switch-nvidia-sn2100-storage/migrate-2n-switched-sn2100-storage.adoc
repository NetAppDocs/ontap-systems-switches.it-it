...
NOTE: Consultare link:cabling-considerations-sn2100-storage.html["Considerazioni sul cablaggio e sulla configurazione"] per avvertenze e ulteriori dettagli.
