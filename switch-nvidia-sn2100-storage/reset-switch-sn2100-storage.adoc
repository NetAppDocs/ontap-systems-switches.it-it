...
summary: Ripristina lo switch di archiviazione NVIDIA SN2100 alle impostazioni di fabbrica cancellando la configurazione corrente dello switch. 
---
= Ripristina lo switch di archiviazione NVIDIA SN2100 alle impostazioni di fabbrica
:allow-uri-read: 


[role="lead"]
Ripristina lo switch di archiviazione NVIDIA SN2100 alle impostazioni di fabbrica cancellando la configurazione corrente dello switch e riportando lo switch alle impostazioni originali.
...
NOTE: Per ulteriori informazioni sull'installazione di Cumulus Linux, fare riferimento a link:configure-software-sn2100-storage.html["Flusso di lavoro di installazione del software per gli switch NVIDIA SN2100"].
...
Consultare la documentazione NVIDIA https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-511/Installation-Management/Factory-Reset/["Ripristino delle impostazioni di fabbrica"^] per ulteriori dettagli.

--
====
.Cosa c'è dopo?
Dopo aver ripristinato gli switch, puoilink:configure-overview-sn2100-storage.html["riconfigurare"] secondo necessità.
