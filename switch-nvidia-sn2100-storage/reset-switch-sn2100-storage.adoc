...
NOTE: Per ulteriori informazioni sull'installazione di Cumulus Linux, vederelink:configure-software-sn2100-storage.html["Workflow di installazione del software per switch NVIDIA SN2100"] .
