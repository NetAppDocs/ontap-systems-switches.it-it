...
NOTE: Per ulteriori informazioni sull'installazione di Cumulus Linux, vederelink:configure-software-sn2100-storage.html["Flusso di lavoro di installazione del software per gli switch NVIDIA SN2100"] .
