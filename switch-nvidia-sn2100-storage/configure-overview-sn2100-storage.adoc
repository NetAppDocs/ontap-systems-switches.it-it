...
summary: Segui questo workflow per installare e configurare gli switch di storage NVIDIA SN2100 in un ambiente ONTAP. 
---
= Procedura di installazione e configurazione degli switch di storage NVIDIA SN2100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Segui questo flusso di lavoro per installare e configurare gli switch di storage NVIDIA SN2100 in un ambiente ONTAP. Lo switch di storage SN2100 instrada i dati tra i server e gli array di storage che eseguono ONTAP.

Segui questi passaggi del flusso di lavoro per installare e configurare gli switch SN2100.
