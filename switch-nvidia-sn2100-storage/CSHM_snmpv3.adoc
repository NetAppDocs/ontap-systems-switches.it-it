...
----
====
. Verificare che il numero seriale da interrogare con l'utente SNMPv3 appena creato sia lo stesso descritto nel passaggio precedente una volta completato il periodo di polling CSHM.
+
