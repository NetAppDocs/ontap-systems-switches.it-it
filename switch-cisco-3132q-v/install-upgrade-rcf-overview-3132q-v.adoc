...
|===
.RCF disponibili
Nella tabella seguente sono elencati gli RCF disponibili per gli switch 3132Q-V.  Scegli la versione RCF applicabile alla tua configurazione. Vederelink:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Switch Ethernet Cisco"^] per maggiori informazioni.
...
Per i dettagli delle configurazioni RCF disponibili, vederelink:configure-software-overview-3132q-v-cluster.html["Flusso di lavoro di installazione del software"] .
