...
Per i dettagli delle configurazioni RCF disponibili, vederelink:configure-software-overview-3132q-v-cluster.html["Workflow di installazione del software"] .
