...
summary: Ripristina lo switch cluster Cisco Nexus 3132Q-V alle impostazioni di fabbrica cancellando la configurazione corrente dello switch. 
---
= Ripristina lo switch cluster Cisco Nexus 3132Q-V alle impostazioni di fabbrica
:allow-uri-read: 


[role="lead"]
Reimposta lo switch di cluster Cisco Nexus 3132Q-V alle impostazioni di fabbrica cancellando la configurazione corrente dello switch e ripristinando le impostazioni originali dello switch.
...
.Cosa c'è dopo?
Dopo aver reimpostato l'interruttore, puoi link:install-overview-cisco-3132qv.html["riconfigurare"] configurarlo in base alle tue esigenze.
