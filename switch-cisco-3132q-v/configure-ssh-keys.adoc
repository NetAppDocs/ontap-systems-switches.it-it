...
summary: 'SSH è un requisito quando si utilizzano le funzionalità Cluster Switch Health Monitor \(CSHM\) e di raccolta dei registri. Per abilitare SSH sugli switch del cluster Cisco 3132Q-V, è necessario prima generare le chiavi SSH e poi abilitare SSH.' 
---
