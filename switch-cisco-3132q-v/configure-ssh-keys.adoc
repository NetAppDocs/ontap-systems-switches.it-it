...
summary: Verifica che SSH e le chiavi SSH siano abilitati sugli switch di cluster Cisco Nexus 3132Q-V per supportare CSHM e la raccolta dei log. 
---
= Verifica la configurazione SSH per gli switch cluster Cisco Nexus 3132Q-V
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verifica che SSH e le chiavi SSH siano abilitati sugli switch di cluster Cisco Nexus 3132Q-V per supportare le funzionalità di Ethernet Switch Health Monitor (CSHM) e raccolta dei log.
