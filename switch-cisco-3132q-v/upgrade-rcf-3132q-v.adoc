...
This command will reboot the system. (y/n)?  [n] *y*
----
. Riapplica alla configurazione dello switch tutte le personalizzazioni precedenti. Consulta link:cabling-considerations-3132q-v.html["Rivedi i requisiti di cablaggio e configurazione"] per i dettagli su eventuali ulteriori modifiche necessarie.
