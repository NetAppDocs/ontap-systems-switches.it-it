...
* Gli altri due nodi utilizzano due cavi in fibra di interconnessione cluster da 40 GbE: E4a e e4e.
...
+
link:shttps://mysupport.netapp.com/site/products/all/details/cisco-cluster-storage-switch/downloads-tab["Download del file di configurazione di riferimento di Cisco® Cluster and Management Network Switch"^]
