...
summary: Puoi usare questa procedura per installare il software NX-OS sullo switch di cluster Nexus 3132Q-V. 
---
...
[role="lead"]
Segui questa procedura per installare il software NX-OS sullo switch cluster Nexus 3132Q-V.
