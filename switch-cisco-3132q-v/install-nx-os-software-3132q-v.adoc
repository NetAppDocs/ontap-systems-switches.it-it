...
summary: Installa il software NX-OS sugli switch di cluster Cisco Nexus 3132Q-V per prepararli al funzionamento del cluster. 
---
= Installa il software NX-OS sugli switch di cluster Cisco Nexus 3132Q-V
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa il software NX-OS sugli switch di cluster Cisco Nexus 3132Q-V per prepararli al funzionamento del cluster.
...
* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Switch Ethernet Cisco"^]. Consultare la tabella di compatibilità dello switch per le versioni ONTAP e NX-OS supportate.
* https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Switch Cisco Nexus serie 3000"^]. Consulta il software appropriato e le guide di aggiornamento disponibili sul sito web di Cisco per la documentazione completa sulle procedure di upgrade e downgrade degli switch Cisco.
...
Assicurati di completare la procedura in link:prepare-install-cisco-nexus-3132q.html["Preparati a installare il software NX-OS e il Reference Configuration File"] e poi segui i passaggi seguenti.
...
. Copia il software NX-OS sullo switch Nexus 3132Q-V utilizzando uno dei seguenti protocolli di trasferimento: FTP, TFTP, SFTP o SCP. Per ulteriori informazioni sui comandi Cisco, consulta la guida appropriata in link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Riferimento ai comandi di Cisco Nexus 3000 Series NX-OS"^].
+
.Mostra esempio
[%collapsible]
====
...
----
====
. Ripeti i passaggi da 6 a 11 sullo switch cs1.
