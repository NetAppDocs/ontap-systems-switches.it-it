...
summary: 'Prepara gli switch cluster Cisco Nexus 3132Q-V prima di installare il software NX-OS e il file di configurazione (RCF).' 
---
= Preparati a installare il software NX-OS e l'RCF sugli switch di cluster Cisco Nexus 3132Q-V
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prepara gli switch cluster Cisco Nexus 3132Q-V prima di installare il software NX-OS e il file di configurazione (RCF). NX-OS e l'RCF devono essere installati prima che lo switch possa operare in un cluster ONTAP.
...
--
====
. [[step6]]Verifica che il comando  `auto-revert` sia abilitato su tutte le LIF del cluster:
+
...
.Cosa succederà ora?
Dopo che ti sei preparato per installare il software NX-OS e RCF, link:install-nx-os-software-3132q-v.html["installare il software NX-OS"].
