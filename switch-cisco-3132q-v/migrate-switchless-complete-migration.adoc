...
---
= Completa la migrazione da cluster a due nodi senza switch a cluster a due nodi con switch
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
--
====
. [[step6]]se è stata eliminata la creazione automatica del caso, riattivarla richiamando un messaggio AutoSupport:
+
