...
summary: È possibile installare lo switch Cisco Nexus 3132Q-V e il pannello pass-through in un cabinet NetApp con le staffe standard incluse con lo switch. 
---
= Installare uno switch cluster Cisco Nexus 3132Q-V in un cabinet NetApp
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A seconda della configurazione, potrebbe essere necessario installare lo switch Cisco Nexus 3132Q-V e il pannello pass-through in un cabinet NetApp con le staffe standard incluse con lo switch.

.Di cosa hai bisogno
* I requisiti di preparazione iniziale, il contenuto del kit e le precauzioni di sicurezza in http://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus3000/hw/installation/guide/b_n3000_hardware_install_guide.html["Guida all'installazione dell'hardware di Cisco Nexus serie 3000"^]. Esaminare questi documenti prima di iniziare la procedura.
* Il kit pannello pass-through, disponibile presso NetApp (codice X8784-R6). Il kit di pannelli pass-through NetApp contiene il seguente hardware:
+
...
* Otto viti da 10-32 o 12-24 e dadi a clip per montare le staffe e le guide di scorrimento sui montanti anteriori e posteriori dell'armadio.
...
. Installare le staffe per il montaggio in rack sullo chassis dello switch Nexus 3132Q-V.
+
...
+
I due interruttori 3132Q-V saranno sempre montati nella parte superiore 2U del cabinet RU41 e 42.
...
+
image::../media/3132q_v_positioning.gif[Posizionamento del 3132Q-V su U39-40]
...
. Collegare la porta di gestione di ogni switch 3132Q-V a uno degli switch di gestione (se ordinati) o collegarli direttamente alla rete di gestione.
+
