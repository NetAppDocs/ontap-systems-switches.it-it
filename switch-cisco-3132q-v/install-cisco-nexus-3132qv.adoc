...
summary: Puoi installare lo switch Cisco Nexus 3132Q-V e il pannello passante in un armadio NetApp utilizzando le staffe standard incluse con lo switch. 
---
= Installa uno switch di cluster Cisco Nexus 3132Q-V in un armadio NetApp
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A seconda della configurazione, potresti dover installare lo switch Cisco Nexus 3132Q-V e il pannello pass-through in un NetApp cabinet utilizzando le staffe standard incluse con lo switch.

.Prima di iniziare
* I requisiti di preparazione iniziale, il contenuto del kit e le precauzioni di sicurezza nel http://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus3000/hw/installation/guide/b_n3000_hardware_install_guide.html["Guida all'installazione hardware Cisco Nexus 3000 Series"^]. Consulta questi documenti prima di iniziare la procedura.
* Il kit del pannello passante, disponibile da NetApp (codice articolo X8784-R6). Il kit del pannello passante NetApp contiene il seguente hardware:
+
...
* Otto viti 10-32 o 12-24 e dadi a clip per montare le staffe e le guide scorrevoli sui montanti anteriori e posteriori del cabinet.
* Kit di montaggio su guida standard Cisco per installare lo switch in un cabinet NetApp.
...
. Installa le staffe per il montaggio a rack sullo chassis dello switch Nexus 3132Q-V.
+
...
+
I due switch 3132Q-V saranno sempre montati nei 2U superiori del cabinet RU41 e RU42.
...
+
image::../media/3132q_v_positioning.gif[Posizionamento del 3132Q-V presso U39-40]
...
+
_(2) Fai scorrere delicatamente l'interruttore finché le staffe di montaggio anteriori non sono a filo con i montanti anteriori._
...
NOTE: Utilizzando lo switch già installato come supporto, non devi tenere la parte anteriore del secondo switch durante il processo di installazione.
...
. Collega la porta di gestione di ogni switch 3132Q-V a uno degli switch di gestione (se ordinati) oppure collegala direttamente alla tua rete di gestione.
+
