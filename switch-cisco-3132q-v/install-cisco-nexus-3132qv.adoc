...
summary: È possibile installare lo switch Cisco Nexus 3132Q-V e il pannello pass-through in un cabinet NetApp utilizzando le staffe standard incluse con lo switch. 
---
...
* Otto viti 10-32 o 12-24 e dadi a clip per montare le staffe e le guide scorrevoli sui montanti anteriori e posteriori del mobile.
...
. Installare le staffe di montaggio su rack sullo chassis dello switch Nexus 3132Q-V.
+
...
+
I due switch 3132Q-V saranno sempre montati nella parte superiore 2U dell'armadio RU41 e 42.
...
+
image::../media/3132q_v_positioning.gif[Posizionamento 3132Q-V a U39-40]
...
. Collegare la porta di gestione su ogni switch 3132Q-V a uno degli switch di gestione (se ordinati) oppure collegarli direttamente alla rete di gestione.
+
