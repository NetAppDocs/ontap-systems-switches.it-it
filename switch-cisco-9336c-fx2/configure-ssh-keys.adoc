...
summary: Verifica che SSH e le chiavi SSH siano abilitati sugli switch di cluster Cisco Nexus 9336C-FX2 per supportare CSHM e la raccolta dei log. 
---
= Verifica la configurazione SSH per gli switch cluster Cisco Nexus 9336C-FX2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verifica che SSH e le chiavi SSH siano abilitati sugli switch di cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T per supportare le funzionalità di health monitor degli switch Ethernet (CSHM) e di raccolta dei log.
