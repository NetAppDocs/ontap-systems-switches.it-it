...
+
Per la documentazione completa sulle procedure di aggiornamento e di downgrade degli switch Cisco, consultare le guide appropriate per il software e l'aggiornamento disponibili sul sito Web Cisco.
...
Gli esempi di questa procedura utilizzano quattro nodi. Questi nodi utilizzano due porte di interconnessione cluster 10GbE e0a e e0b. Vedere https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe"] per verificare le porte cluster corrette sulle piattaforme.
...
.. Per NX-OS 10,2 e versioni successive, utilizzare il `show diff running-config` Comando per confrontare con il file RCF salvato nel bootflash.  In caso contrario, utilizzare uno strumento di confronto/diff in terza parte.
...
. Riapplicare eventuali aggiunte personalizzate precedentemente identificate alla configurazione dello switch.
...
----
====
. Ripetere i passaggi da 1 a 18 sull'interruttore CS2.
