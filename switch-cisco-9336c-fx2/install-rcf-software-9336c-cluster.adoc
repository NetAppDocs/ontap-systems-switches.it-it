...
summary: 'Installa il file di configurazione di riferimento (RCF) sugli switch cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T dopo la configurazione iniziale per configurare le assegnazioni delle porte, le VLAN e le impostazioni di rete.' 
---
= Installa l'RCF sugli switch di cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa il file di configurazione di riferimento (RCF) sugli switch cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T dopo la configurazione iniziale. L'RCF definisce le assegnazioni delle porte, le VLAN e le impostazioni di rete necessarie per il funzionamento del cluster.
