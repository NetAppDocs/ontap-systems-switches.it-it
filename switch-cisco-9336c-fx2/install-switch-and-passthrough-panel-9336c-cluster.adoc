...
summary: Installa gli switch cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T e un pannello passante in un armadio NetApp usando le staffe standard incluse con lo switch. 
---
= Installa uno switch di cluster Cisco Nexus 9336C-FX2 e un pannello passante in un armadio NetApp
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa gli switch cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T e un pannello passante in un armadio NetApp usando le staffe standard incluse con lo switch.
...
* Per i requisiti di preparazione iniziale, il contenuto del kit e le precauzioni di sicurezza, fare riferimento al link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/aci_9336cfx2_hig/guide/b_n9336cFX2_aci_hardware_installation_guide.html["Guida all'installazione dell'hardware Cisco Nexus serie 9000"^].
