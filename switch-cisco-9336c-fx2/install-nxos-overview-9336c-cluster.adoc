...
summary: 'Prepara gli switch cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T prima di installare il software NX-OS e il file di configurazione di riferimento (RCF).' 
---
= Preparati a installare il software NX-OS e RCF sugli switch di cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T
:allow-uri-read: 


[role="lead"]
Prepara gli switch cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T prima di installare il software NX-OS e il file di configurazione (RCF). NX-OS e l'RCF devono essere installati prima che lo switch possa operare in un cluster ONTAP.
...
.Cosa succederà ora?
Dopo esserti preparato per installare il software NX-OS e RCF, puoi link:install-nxos-software-9336c-cluster.html["installare o aggiornare il software NX-OS"].
