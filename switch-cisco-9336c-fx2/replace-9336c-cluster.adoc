...
summary: Sostituisci uno switch di cluster Cisco Nexus 9336C-FX2 o 9336C-FX2-T difettoso in una rete di cluster. Questa è una procedura senza interruzioni. 
---
...
[role="lead"]
Sostituisci uno switch di cluster Cisco Nexus 9336C-FX2 o 9336C-FX2-T difettoso in una rete di cluster senza interrompere il funzionamento del cluster. Questa procedura non distruttiva (NDU) prevede la preparazione di uno switch sostitutivo e la migrazione delle connessioni dallo switch guasto.
...
** L' ONTAP `cluster ping-cluster -node node1` il comando deve indicare che la connettività di base e la comunicazione più grande di PMTU hanno esito positivo su tutti i percorsi.


* Sull'interruttore sostitutivo Nexus 9336C-FX2:
+
...
** La personalizzazione iniziale dello switch è completa, come dettagliato inlink:setup-switch-9336c-cluster.html["Configurare lo switch cluster 9336C-FX2"] .
+
...
. Sul nuovo switch, accedi come amministratore e chiudi tutte le porte che saranno connesse alle interfacce del cluster di nodi (porte da 1/1 a 1/34).
+
...
. Disattivare le porte ISL 1/35 e 1/36 sullo switch Nexus 9336C-FX2 cs1.
+
.Mostra esempio
[%collapsible]
====
...
----
====
. Rimuovere tutti i cavi dallo switch Nexus 9336C-FX2 cs2, quindi collegarli alle stesse porte sullo switch Nexus C9336C-FX2 newcs2.
. Attivare le porte ISL 1/35 e 1/36 tra gli switch cs1 e newcs2, quindi verificare lo stato operativo del canale porta.
+
...
[%collapsible]
====
Questo esempio abilita le porte ISL 1/35 e 1/36 e visualizza il riepilogo del canale porta sullo switch cs1:
