...
summary: Segui questo flusso di lavoro per installare e configurare gli switch cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T in un ambiente ONTAP. 
---
...
[role="lead"]
Segui questo flusso di lavoro per installare e configurare gli switch cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T in un ambiente ONTAP. Questi switch fanno parte della piattaforma Cisco Nexus 9000 e supportano cluster ONTAP con più di due nodi.
