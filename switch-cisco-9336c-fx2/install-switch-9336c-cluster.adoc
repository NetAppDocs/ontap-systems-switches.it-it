...
Facoltativamente, puoilink:install-switch-and-passthrough-panel-9336c-cluster.html["Installare uno switch Cisco Nexus 9336C-FX2 in un cabinet NetApp"] . Altrimenti vai alink:cabling-considerations-9336c-fx2.html["rivedere il cablaggio e la configurazione"] .
