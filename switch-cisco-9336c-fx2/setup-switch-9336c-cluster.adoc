...
---
= Configurare lo switch del cluster 9336C-FX2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Se lo si desidera, è possibile link:install-switch-and-passthrough-panel-9336c-cluster.html["Installare uno switch Cisco Nexus 9336C-FX2 in un cabinet NetApp"]. In caso contrario, passare a. link:install-nxos-overview-9336c-cluster.html["Preparazione all'installazione di NX-OS e RCF"].
