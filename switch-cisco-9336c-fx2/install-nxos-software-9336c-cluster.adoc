...
.Cosa succederà ora?
Dopo aver installato o aggiornato il software NX-OS, puoilink:install-upgrade-rcf-overview-cluster.html["installare o aggiornare il file di configurazione di riferimento (RCF)"] .
