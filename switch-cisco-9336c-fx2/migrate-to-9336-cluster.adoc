...
summary: Migra gli switch di cluster Cisco meno recenti agli switch di cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T senza interrompere il funzionamento del cluster. 
---
= Esegui la migrazione dai vecchi switch Cisco agli switch di cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Migra gli switch di cluster Cisco meno recenti agli switch di cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T senza interrompere il funzionamento del cluster.
