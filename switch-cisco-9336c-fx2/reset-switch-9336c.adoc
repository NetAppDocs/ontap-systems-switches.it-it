...
---
= Ripristinare lo switch del cluster 9336C-FX2 ai valori predefiniti di fabbrica
:allow-uri-read: 


[role="lead"]
Per ripristinare le impostazioni predefinite di fabbrica dello switch cluster 9336C-FX2, è necessario cancellare le impostazioni dello switch 9336C-FX2.
