...
summary: Migra gli switch cluster NetApp CN1610 ai cluster switch Cisco Nexus 9336C-FX2 e 9336C-FX2-T senza interrompere il funzionamento del cluster. 
---
= Esegui la migrazione dagli switch di cluster NetApp CN1610 agli switch di cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Migra gli switch cluster NetApp CN1610 esistenti agli switch cluster Cisco Nexus 9336C-FX2 e 9336C-FX2-T senza interrompere il funzionamento del cluster.
