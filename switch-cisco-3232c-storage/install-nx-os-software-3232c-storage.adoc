...
summary: Installa o aggiorna il software NX-OS sugli switch di storage Cisco Nexus 3232C. 
---
= Installa o aggiorna il software NX-OS sugli switch di storage Cisco Nexus 3232C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa o aggiorna il software NX-OS sugli switch di storage Cisco Nexus 3232C per prepararli all'operatività nella rete di storage.
...
----
====
. Se stai aggiornando alla versione 9.3(11) di NX-OS, devi aggiornare l'immagine EPLD `golden` e riavviare di nuovo lo switch. Altrimenti, salta al passaggio 12.
+
Vedi https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["Note di rilascio dell'aggiornamento EPLD, Release 9.3(11)"^] per ulteriori dettagli.
...
----
====
. Dopo il riavvio dello switch, accedi per verificare che la nuova versione di EPLD sia stata caricata correttamente.
+
.Mostra esempio
[%collapsible]
====
...
----
====
. Se stai configurando lo switch per la prima volta, passa al passaggio 15. Se stai aggiornando lo switch, procedi al passaggio successivo.
