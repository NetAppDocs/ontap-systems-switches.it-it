...
summary: 'Aggiorna il file di configurazione (RCF) sugli switch di storage Cisco Nexus 3232C quando è disponibile una versione più recente.' 
---
= Aggiorna l'RCF sugli switch di storage Cisco Nexus 3232C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiorna il file di configurazione (RCF) sugli switch di storage Cisco Nexus 3232C quando è disponibile una versione più recente dell'RCF.
...
+
Per ulteriori informazioni sui comandi Cisco, consultare la guida appropriata nella  https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/series.html["Documentazione Cisco Nexus 3000 Series"^].
