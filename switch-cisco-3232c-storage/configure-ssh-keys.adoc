...
summary: Verifica che SSH e le relative chiavi siano abilitati sugli switch di storage Cisco Nexus 3232C per supportare CSHM e la raccolta dei log. 
---
= Verifica la configurazione SSH per gli switch di storage Cisco Nexus 3232C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verifica che SSH e le chiavi SSH siano abilitati sugli switch di storage Cisco Nexus 3232C per supportare le funzionalità di monitoraggio dello stato degli switch Ethernet (CSHM) e la raccolta dei log.
