...
Se lo si desidera, è possibile link:install-switch-and-passthrough-panel-9336c-storage.html["Installare uno switch Cisco Nexus 9336C-FX2 in un cabinet NetApp"]. In caso contrario, passare a. link:install-nxos-overview-9336c-storage.html["Preparazione all'installazione di NX-OS e RCF"].
