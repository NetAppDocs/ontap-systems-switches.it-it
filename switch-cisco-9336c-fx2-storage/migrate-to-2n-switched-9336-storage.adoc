...
summary: Migra un cluster senza switch a due nodi esistente a un ambiente cluster con switch utilizzando gli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T. 
---
= Esegui la migrazione a un cluster a due nodi con switch di storage Cisco Nexus 9336C-FX2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Esegui la migrazione di un cluster senza switch a due nodi esistente a un ambiente cluster con switch utilizzando gli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T. Questa migrazione senza interruzioni ti permette di scalare il cluster oltre due nodi.
...
* Vedere link:https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe - Interruttori"^] per maggiori informazioni sul cablaggio.
