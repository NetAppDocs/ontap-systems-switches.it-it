...
[role="lead"]
Se si dispone di un ambiente cluster a due nodi _senza switch_, è possibile migrare a un ambiente cluster a due nodi _con switch_ utilizzando gli switch Cisco Nexus 9336C-FX2 per poter scalare oltre due nodi nel cluster.
