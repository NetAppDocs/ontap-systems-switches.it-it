...
summary: Ripristina gli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T alle impostazioni di fabbrica cancellando la configurazione corrente dello switch. 
---
= Reimposta gli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T alle impostazioni di fabbrica
:allow-uri-read: 


[role="lead"]
Ripristina gli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T alle impostazioni di fabbrica cancellando la configurazione corrente dello switch e riportando gli switch alle impostazioni originali.
...
.Cosa c'è dopo?
Dopo aver ripristinato gli switch, puoilink:configure-switch-overview-9336c-storage.html["riconfigurare"] secondo necessità.
