...
Facoltativamente, puoilink:install-switch-and-passthrough-panel-9336c-storage.html["Installare uno switch Cisco Nexus 9336C-FX2 in un cabinet NetApp"] .  Altrimenti vai alink:setup-switch-9336c-storage.html["Configurare lo switch"] .
