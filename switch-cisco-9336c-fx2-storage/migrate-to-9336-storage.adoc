...
summary: È possibile migrare i vecchi switch cluster Cisco non disruptivi per un cluster ONTAP verso gli switch di rete cluster Cisco Nexus 9336C-FX2. 
---
...
[role="lead"]
È possibile migrare i vecchi switch Cisco per un cluster ONTAP sugli switch di rete di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T. Si tratta di una procedura non distruttiva.
