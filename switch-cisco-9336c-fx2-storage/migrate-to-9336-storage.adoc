...
summary: Migra gli switch Cisco meno recenti agli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T senza interrompere il funzionamento della rete di storage. 
---
= Esegui la migrazione dai vecchi switch Cisco agli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Migra gli switch Cisco meno recenti agli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T senza interrompere il funzionamento della rete di storage.
