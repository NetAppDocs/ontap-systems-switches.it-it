...
summary: Installa gli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T e un pannello passante in un armadio NetApp usando le staffe standard incluse con lo switch. 
---
= Installa gli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T in un armadio NetApp
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa gli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T e un pannello passante in un armadio NetApp usando le staffe standard incluse con lo switch.

.Prima di iniziare
Assicurati di avere quanto segue:

* Per ogni switch è necessario fornire le otto viti 10-32 o 12-24 e i dadi a clip per montare le staffe e le guide scorrevoli sui montanti anteriori e posteriori del mobile.
* Per installare lo switch in un cabinet NetApp è necessario utilizzare il kit di guide standard Cisco .
...
Rivedere i requisiti di preparazione iniziale, il contenuto del kit e le precauzioni di sicurezza nel https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/aci_9336cfx2_hig/guide/b_n9336cFX2_aci_hardware_installation_guide.html["Guida all'installazione dell'hardware Cisco Nexus serie 9000"^] .
...
+
I due switch 9336C-FX2 saranno sempre montati nella parte superiore 2U dell'armadio RU41 e 42.
...
. Collegare la porta di gestione su ogni switch 9336C-FX2 a uno degli switch di gestione (se ordinati) oppure collegarli direttamente alla rete di gestione.
+
