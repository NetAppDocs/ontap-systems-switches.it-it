...
summary: 'Aggiorna il file di configurazione di riferimento (RCF) sugli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T quando è disponibile una versione più recente.' 
---
= Aggiorna l'RCF sugli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiorna il file di configurazione (RCF) sugli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T quando è disponibile una versione più recente dell'RCF.
...
. Accedere allo switch s2 utilizzando SSH o utilizzando una console seriale.
. Spegnere le porte collegate a tutte le porte dei nodi.
+
[listing, subs="+quotes"]
----
s2> *enable*
...
. Verificare che le porte dello switch collegate alle porte storage del nodo e alle porte dello storage shelf siano *up*.
+
[source, cli]
----
