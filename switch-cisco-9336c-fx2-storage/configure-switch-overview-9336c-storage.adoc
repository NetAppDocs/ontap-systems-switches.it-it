...
summary: Segui questo flusso di lavoro per installare e configurare gli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T in un ambiente ONTAP. 
---
= Procedura di installazione e configurazione per gli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Segui questo flusso di lavoro per installare e configurare gli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T in un ambiente ONTAP. Questi switch fanno parte della piattaforma Cisco Nexus 9000 e supportano la connettività di rete di storage per i sistemi ONTAP.
