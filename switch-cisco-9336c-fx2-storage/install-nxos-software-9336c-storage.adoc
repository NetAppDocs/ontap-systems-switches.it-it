...
summary: Installa o aggiorna il software NX-OS sugli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T. 
---
= Installa o aggiorna il software NX-OS sugli switch di storage Cisco Nexus 9336C-FX2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa o aggiorna il software NX-OS sugli switch di storage Cisco Nexus 9336C-FX2 e 9336C-FX2-T. NX-OS deve essere installato prima che tu possa configurare lo switch o installare il file di configurazione di riferimento (RCF).
