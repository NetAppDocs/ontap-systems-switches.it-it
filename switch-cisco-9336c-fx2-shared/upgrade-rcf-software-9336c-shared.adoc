...
summary: 'Aggiorna il file di configurazione di riferimento (RCF) su uno switch condiviso Cisco Nexus 9336C-FX2 quando è disponibile una versione più recente.' 
---
= Aggiorna l'RCF su uno switch condiviso Cisco Nexus 9336C-FX2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiorna il file di configurazione (RCF) su uno switch condiviso Cisco Nexus 9336C-FX2 quando è disponibile una versione più recente dell'RCF.
...
----
====
. Controllare lo stato amministrativo e operativo di ciascuna porta del cluster, porta di archiviazione del nodo e porta dello shelf di archiviazione.
+
...
+
.. Registrare eventuali aggiunte personalizzate tra il file running-config corrente e il file RCF in uso (ad esempio una configurazione SNMP per la propria organizzazione).
...
. Fare riferimento a link:cabling-considerations-9336c-shared.html["Esaminare le considerazioni sul cablaggio e sulla configurazione"] per dettagli su eventuali ulteriori modifiche necessarie.
...
----
====
. Ripeti i passaggi da 1 a 21 sullo switch cs2.
...
====
.Cosa succederà ora?
Dopo aver aggiornato l'RCF, puoi link:../switch-cshm/config-overview.html["configurare il monitoraggio dello stato dello switch"].
