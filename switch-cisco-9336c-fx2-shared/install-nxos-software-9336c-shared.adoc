...
summary: Installa il software NX-OS su uno switch condiviso Cisco Nexus 9336C-FX2 per prepararlo al funzionamento in cluster e storage condivisi. 
---
= Installa il software NX-OS su uno switch condiviso Cisco Nexus 9336C-FX2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa il software NX-OS su uno switch condiviso Cisco Nexus 9336C-FX2 per prepararlo al funzionamento in cluster e storage condivisi.
