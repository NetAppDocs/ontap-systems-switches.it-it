...
keywords:  
summary: Sostituisci uno switch condiviso Cisco Nexus 9336C-FX2 difettoso. Questa è una procedura senza interruzioni. 
---
...
[role="lead"]
Sostituisci uno switch condiviso Cisco Nexus 9336C-FX2 difettoso senza interrompere il funzionamento del cluster o della rete di storage. Questa procedura non distruttiva (NDU) prevede la preparazione di uno switch sostitutivo e il ripristino della configurazione dello switch condiviso.
