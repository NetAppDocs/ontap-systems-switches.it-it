...
summary: Installa uno switch condiviso Cisco Nexus 9336C-FX2 e un pannello passante in un armadio NetApp utilizzando le staffe standard incluse con lo switch. 
---
= Installa uno switch condiviso Cisco Nexus 9336C-FX2 in un armadio NetApp
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa uno switch condiviso Cisco Nexus 9336C-FX2 e un pannello passante in un armadio NetApp utilizzando le staffe standard incluse con lo switch.
