...
keywords:  
summary: 'Prepara uno switch condiviso Cisco Nexus 9336C-FX2 prima di installare il software NX-OS e il file di configurazione (RCF).' 
---
= Prepara l'installazione del software NX-OS e di RCF su uno switch condiviso Cisco Nexus 9336C-FX2
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Prepara uno switch condiviso Cisco Nexus 9336C-FX2 prima di installare il software NX-OS e il file di configurazione (RCF). NX-OS e l'RCF devono essere installati prima che lo switch possa operare in un ambiente ONTAP.
