...
| link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/sw/mib/reference/MIBRef.html["Cisco Nexus 9000 MIB Reference"] | Descrive i file MIB (Management Information base) per i centralini Nexus 9000. 
