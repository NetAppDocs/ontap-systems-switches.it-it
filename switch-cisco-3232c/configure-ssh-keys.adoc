...
summary: Verifica che SSH e le chiavi SSH siano abilitati sugli switch cluster Cisco Nexus 3232C per supportare CSHM e la raccolta dei log. 
---
= Verifica la configurazione SSH per gli switch cluster Cisco Nexus 3232C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verifica che SSH e le relative chiavi SSH siano abilitati sugli switch cluster Cisco Nexus 3232C per supportare le funzionalità di monitoraggio dello stato degli switch Ethernet (CSHM) e di raccolta dei log.
