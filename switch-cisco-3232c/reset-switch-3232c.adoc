...
summary: Ripristina lo switch cluster Cisco Nexus 3232C alle impostazioni di fabbrica cancellando la configurazione corrente dello switch. 
---
= Ripristina lo switch cluster Cisco Nexus 3232C alle impostazioni di fabbrica
:allow-uri-read: 


[role="lead"]
Reimposta lo switch di cluster Cisco Nexus 3232C alle impostazioni di fabbrica cancellando la configurazione corrente dello switch e ripristinando le impostazioni originali dello switch.
