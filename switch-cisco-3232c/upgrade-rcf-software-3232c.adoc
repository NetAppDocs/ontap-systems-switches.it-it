...
+
Per ulteriori informazioni sui comandi Cisco, fare riferimento alla guida appropriata in link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Riferimento ai comandi NX-OS della serie Cisco Nexus 3000"^].
