...
summary: È possibile utilizzare questa procedura per installare il software NX-OS sullo switch cluster Nexus 3232C. 
---
...
+
Consultare link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["Note di rilascio dell'aggiornamento EPLD, versione 9.3(11)"^] per ulteriori dettagli.
