...
summary: Installa il software NX-OS sugli switch di cluster Cisco Nexus 3232C per prepararli al funzionamento del cluster. 
---
= Installa il software NX-OS sugli switch di cluster Cisco Nexus 3232C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa il software NX-OS sugli switch di cluster Cisco Nexus 3232C per prepararli al funzionamento del cluster.
...
+
Consulta link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["Note di rilascio dell'aggiornamento EPLD, Release 9.3(11)"^] per ulteriori dettagli.
...
----
====
. Ripeti i passaggi da 6 a 14 sullo switch cs1.
...
.Cosa succederà ora?
Dopo aver installato il software NX-OS, puoi link:install-upgrade-rcf-overview-3232c.html["installare o aggiornare il file di configurazione di riferimento (RCF)"].
