...
.Cosa succederà ora?
Dopo aver installato il software NX-OS, link:install-upgrade-rcf-overview-3232c.html["installare o aggiornare il file di configurazione di riferimento (RCF)"].
