...
summary: Puoi usare questa procedura per installare il software NX-OS sullo switch di cluster Nexus 3232C. 
---
...
[role="lead"]
Puoi usare questa procedura per installare il software NX-OS sullo switch di cluster Nexus 3232C.
