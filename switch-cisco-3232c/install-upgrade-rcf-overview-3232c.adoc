...
.Cosa succederà ora?
Dopo aver esaminato la procedura di installazione o aggiornamento RCF, è possibilelink:install-rcf-software-3232c.html["installare l'RCF"] Olink:upgrade-rcf-software-3232c.html["aggiorna il tuo RCF"] come richiesto.
