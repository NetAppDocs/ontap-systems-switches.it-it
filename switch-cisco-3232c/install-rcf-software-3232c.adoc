...
summary: SSH è un requisito quando si utilizzano le funzionalità di Cluster Switch Health Monitor e raccolta dei log. Per abilitare SSH sugli switch di cluster Cisco 3232c, è necessario prima generare le chiavi SSH e poi abilitare SSH. 
---
...
[role="lead"]
Installa il file di configurazione di riferimento (RCF) dopo aver configurato per la prima volta gli switch Nexus 3232C.
