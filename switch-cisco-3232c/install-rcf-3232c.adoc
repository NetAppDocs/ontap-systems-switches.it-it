...
summary: 'Puoi installare l"RCF dopo aver configurato per la prima volta lo switch Nexus 3232C. Puoi anche usare questa procedura per aggiornare la versione dell"RCF.' 
---
...
[role="lead"]
Segui questa procedura per installare l'RCF dopo aver configurato per la prima volta lo switch Nexus 3232C.
