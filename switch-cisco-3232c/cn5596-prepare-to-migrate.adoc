...
---
= Prepararsi alla migrazione dagli switch Nexus 5596 agli switch Nexus 3232C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Segui questi passaggi per preparare gli switch Cisco Nexus 5596 alla migrazione agli switch Cisco Nexus 3232C.
...
+
Consultare la pagina di download dei file di configurazione di riferimento per lo switch di rete di gestione e cluster __ONTAP 8.x o versioni successive__, quindi selezionare la versione appropriata.
