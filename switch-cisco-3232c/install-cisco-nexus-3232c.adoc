...
summary: Puoi installare lo switch Cisco Nexus 3232C e il pannello passante in un armadio NetApp utilizzando le staffe standard incluse con lo switch. 
---
= Installa uno switch di cluster Cisco Nexus 3232C in un armadio NetApp
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A seconda della configurazione, potresti dover installare lo switch di cluster Cisco Nexus 3232C e il pannello pass-through in un armadio NetApp utilizzando le staffe standard incluse con lo switch.

.Prima di iniziare
* I requisiti di preparazione iniziale, il contenuto del kit e le precauzioni di sicurezza nel link:http://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus3000/hw/installation/guide/b_n3000_hardware_install_guide.html["Guida all'installazione hardware Cisco Nexus 3000 Series"^].
...
. Installa le staffe per il montaggio a rack sullo chassis dello switch Nexus 3232C.
+
