...
summary: Installa uno switch di cluster Cisco Nexus 3232C e un pannello passante in un armadio NetApp usando le staffe standard incluse con lo switch. 
---
...
[role="lead"]
Installa uno switch di cluster Cisco Nexus 3232C e un pannello passante in un armadio NetApp usando le staffe standard incluse con lo switch.
