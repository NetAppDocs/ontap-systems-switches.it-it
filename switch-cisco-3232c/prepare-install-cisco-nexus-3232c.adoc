...
summary: 'Prepara gli switch cluster Cisco Nexus 3232C prima di installare il software NX-OS e il file di configurazione di riferimento (RCF).' 
---
= Preparati a installare il software NX-OS e l'RCF sugli switch di cluster Cisco Nexus 3232C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prepara gli switch cluster Cisco Nexus 3232C prima di installare il software NX-OS e il file di configurazione (RCF). NX-OS e l'RCF devono essere installati prima che lo switch possa operare in un cluster ONTAP.
...
----
====
.. Visualizza le informazioni sui LIF:
...
.Cosa succederà ora?
Dopo aver preparato l'installazione del software NX-OS e RCF, puoi link:install-nx-os-software-3232c.html["installare il software NX-OS"].
