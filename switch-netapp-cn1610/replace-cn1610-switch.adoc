...
----
====
. Verificare che le versioni dello switch e di ONTAP corrispondano nella matrice di compatibilità. Consultare link:https://mysupport.netapp.com/site/info/netapp-cluster-switch["Switch NetApp CN1601 e CN1610"^] per i dettagli.
