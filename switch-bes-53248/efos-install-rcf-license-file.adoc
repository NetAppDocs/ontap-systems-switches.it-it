...
---
= Installare il file di configurazione di riferimento (RCF) e il file di licenza
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A partire da EFOS 3.12.0.1, è possibile installare il file di configurazione di riferimento (RCF) e il file di licenza dopo aver configurato lo switch cluster BES-53248.
...
* L'attuale RCF, disponibile presso https://mysupport.netapp.com/site/products/all/details/broadcom-cluster-switches/downloads-tab["Switch cluster Broadcom"^] pagina.
