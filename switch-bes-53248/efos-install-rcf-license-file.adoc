...
---
= Installare il file di configurazione (RCF) e il file di licenza
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A partire da EFOS 3.12.0.1, è possibile installare il file RCF e il file di licenza dopo aver configurato lo switch di rete cluster BES-53248.
