...
summary: Segui questo flusso di lavoro per installare e configurare un nuovo switch di cluster Broadcom BES-53248, dalla verifica dei requisiti alla configurazione hardware e software. 
---
= Procedura di installazione e configurazione dello switch cluster Broadcom BES-53248
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Segui questo workflow per installare e configurare un nuovo switch di cluster Broadcom BES-53248 in un ambiente ONTAP. Il BES-53248 è uno switch bare metal che supporta cluster ONTAP da due a 24 nodi.
...
[role="quick-margin-para"]
Configura il monitoraggio dello stato di salute dello switch Ethernet.
