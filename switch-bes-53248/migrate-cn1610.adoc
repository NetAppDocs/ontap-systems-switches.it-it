...
IL https://hwu.netapp.com/Home/Index["_Universo hardware NetApp_"^] contiene informazioni sulla compatibilità ONTAP , sul firmware EFOS supportato e sul cablaggio per gli switch cluster BES-53248.
...
--
====
. [[step5]]Se hai disattivato la creazione automatica dei casi, riattivala richiamando un messaggio AutoSupport :
+
