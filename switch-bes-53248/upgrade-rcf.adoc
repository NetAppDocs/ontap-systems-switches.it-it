...
--
====
. [[step11]]esamina l'output del banner dal `show clibanner` comando. Leggere e seguire queste istruzioni per garantire la corretta configurazione e il corretto funzionamento dello switch.
+
`show clibanner`
