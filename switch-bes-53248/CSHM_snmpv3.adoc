...
summary: 'Configura SNMPv3 sullo switch di cluster Broadcom BES-53248 per abilitare la comunicazione sicura con l"Ethernet switch health monitor (CSHM).' 
---
= Configura SNMPv3 per lo switch di cluster Broadcom BES-53248
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Configura SNMPv3 sullo switch di cluster Broadcom BES-53248 per abilitare la comunicazione sicura e autenticata con l'Ethernet switch health monitor (CSHM). SNMPv3 fornisce il polling crittografato dello stato dello switch per il monitoraggio dell'integrità in ONTAP.
