...
summary: 'Abilita SSH sullo switch di cluster Broadcom BES-53248 per supportare le funzionalità di health monitor dello switch Ethernet (CSHM) e di raccolta dei log.' 
---
= Abilita SSH sullo switch di cluster Broadcom BES-53248
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Abilita SSH sullo switch di cluster Broadcom BES-53248 per supportare le funzionalità di health monitor dello switch Ethernet (CSHM) e di raccolta dei log. Questa procedura spiega come generare le chiavi SSH e attivare l'accesso SSH sullo switch.
