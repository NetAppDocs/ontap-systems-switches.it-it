...
summary: 'SSH è un requisito quando si utilizzano le funzionalità Cluster Switch Health Monitor (CSHM) e raccolta dei log. Per abilitare SSH sugli switch di cluster BES-53248, è necessario prima generare le chiavi SSH e poi abilitare SSH.' 
---
