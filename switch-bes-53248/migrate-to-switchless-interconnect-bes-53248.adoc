...
summary: Esegui la migrazione da una rete cluster con switch Broadcom BES-53248 a una configurazione cluster senza switch a due nodi per ONTAP 9.3 e versioni successive. 
---
= Migra dagli switch di cluster Broadcom BES-53248 a connessioni senza switch
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
