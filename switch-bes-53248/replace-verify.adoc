...
summary: È possibile utilizzare i comandi forniti qui per verificare che tutto sia operativo dopo un aggiornamento dello switch cluster BES-53248. 
---
...
[role="lead"]
È possibile utilizzare i seguenti comandi per verificare lo stato della rete cluster ONTAP dopo un aggiornamento del software EFOS o RCF per gli switch cluster BES-53248.
