...
summary: Configura la raccolta dei log sullo switch di cluster Broadcom BES-53248 per permettere a CSHM di raccogliere i log dello switch per il debug e la segnalazione AutoSupport. 
---
= Configura la raccolta dei log per lo switch di cluster Broadcom BES-53248
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Configura la raccolta dei log sullo switch di cluster Broadcom BES-53248 per permettere all'Ethernet switch health monitor (CSHM) di raccogliere i log dello switch per il debug e la segnalazione AutoSupport. Questa procedura configura sia la raccolta dei log di supporto su richiesta sia la raccolta periodica dei dati ogni ora.
