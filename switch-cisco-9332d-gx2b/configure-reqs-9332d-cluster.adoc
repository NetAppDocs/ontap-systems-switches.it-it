...
* Hai a disposizione il numero e il tipo di cavi e connettori per cavi appropriati per i tuoi switch. Consulta la link:https://hwu.netapp.com["Hardware Universe"^].
