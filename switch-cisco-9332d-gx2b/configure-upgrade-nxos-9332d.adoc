...
summary: Aggiorni NX-OS sugli switch Cisco Nexus 9332D-GX2B per supportare nuovo hardware o una nuova versione di ONTAP sul tuo sistema AFX 1K o AFX 2K. 
---
= Aggiorna NX-OS - Cisco Nexus 9332D-GX2B
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiorni NX-OS sugli switch Cisco Nexus 9332D-GX2B per supportare nuovo hardware o una nuova versione di ONTAP sul tuo sistema AFX 1K o AFX 2K.
