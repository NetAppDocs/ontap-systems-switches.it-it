...
Installi NX-OS sul primo switch (cs1) installando e verificando le nuove versioni di NX-OS ed EPLD, verificando l'integrità di tutte le porte del cluster, e poi ripeti questi passaggi sul secondo switch (cs2).
