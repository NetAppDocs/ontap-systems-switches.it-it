...
summary: Aggiorna NX-OS sugli switch Cisco Nexus 9332D-GX2B per supportare nuovo hardware o una nuova versione di ONTAP sui sistemi AFX 1K o AFX 2K. 
---
= Aggiorna NX-OS sullo switch Cisco Nexus 9332D-GX2B
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiorna NX-OS sugli switch Cisco Nexus 9332D-GX2B per supportare nuovo hardware o una nuova versione di ONTAP sui sistemi AFX 1K o AFX 2K.
...
.Cosa succederà ora?
Dopo che hai aggiornato NX-OS sugli switch, aggiorni l'RCF a partire da link:configure-install-upgrade-rcf-overview-9332d.html["Installa o aggiorna la panoramica RCF"].
