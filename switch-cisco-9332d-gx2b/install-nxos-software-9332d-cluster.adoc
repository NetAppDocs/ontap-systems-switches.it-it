...
summary: È possibile utilizzare questa procedura per installare o aggiornare il software NX-OS sullo switch cluster Nexus 9332D-GX2B. 
---
...
[role="lead"]
Seguire questa procedura per installare o aggiornare il software NX-OS sullo switch Nexus 9332D-GX2B.
...
* Completare la procedura inlink:install-nxos-overview-9332d-cluster.html["Prepararsi all'installazione di NX-OS e RCF"] .
...
----
. Copiare il software NX-OS e le immagini EPLD sullo switch Nexus 9332D-GX2B.
+
.Mostra esempio
[%collapsible]
====
...
----
====
. Ripetere i passaggi da 6 a 13 per installare il software NX-OS e le immagini EPLD sullo switch cs1.
...
.Cosa succederà ora?
Dopo aver installato o aggiornato il software NX-OS, è possibile link:install-upgrade-rcf-overview-cluster-9332d.html["installare o aggiornare il file di configurazione di riferimento (RCF)"].
