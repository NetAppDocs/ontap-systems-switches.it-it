...
summary: 'Aggiorni la versione del Reference Configuration File (RCF) sugli switch Cisco Nexus 9332D-GX2B per supportare nuovo hardware, una nuova versione di ONTAP o per allinearti a una nuova versione di NX-OS nella configurazione del tuo sistema AFX 1K o AFX 2K.' 
---
= Aggiorna la versione RCF - Cisco Nexus 9332D-GX2B
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiorni la versione del Reference Configuration File (RCF) sugli switch Cisco Nexus 9332D-GX2B per supportare nuovo hardware, una nuova versione di ONTAP o per allinearti a una nuova versione di NX-OS nella configurazione del tuo sistema AFX 1K o AFX 2K.
...
+
Se i tuoi switch utilizzano RCF 10.1 o versioni successive, puoi link:configure-install-upgrade-rcf-overview-9332d.html#change-port-speed-configuration["modifica la configurazione della velocità della porta"] se necessario.
...
----
====
. Usando la ONTAP CLI, verifica la connettività delle interfacce del cluster remoto.
+
...
.Cosa succederà ora?
Dopo aver aggiornato l'RCF sui tuoi switch, link:configure-verify-ssh-9332d.html["Verifica SSH per la raccolta dei log"].
