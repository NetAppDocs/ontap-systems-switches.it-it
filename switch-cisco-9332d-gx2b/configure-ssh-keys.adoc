...
summary: SSH è un requisito quando si utilizzano le funzionalità Cluster Switch Health Monitor e raccolta dei log. Per abilitare SSH sugli switch di cluster Cisco 9332d-gx2b, è necessario prima generare le chiavi SSH e poi abilitare SSH. 
---
