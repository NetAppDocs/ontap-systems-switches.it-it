...
summary: 'Il software Cisco NX-OS e i file di configurazione di riferimento \(RCF\) devono essere installati sugli switch cluster Cisco Nexus 9332D-GX2B.' 
---
...
.. *Porte cluster*
+
... Visualizza quante interfacce di interconnessione cluster sono configurate in ciascun nodo per ciascun switch:
+
[source, cli]
----
...
.Cosa succederà ora?
Dopo esserti preparato per installare il software NX-OS e RCF, link:install-nxos-software-9332d-cluster.html["installare o aggiornare il software NX-OS"].
