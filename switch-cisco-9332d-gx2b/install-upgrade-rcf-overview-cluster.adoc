...
[role="lead"]
Si installa il file di configurazione di riferimento (RCF) dopo aver configurato per la prima volta lo switch Nexus 9332D-GX2B. Si aggiorna la versione dell'RCF quando è già installata una versione esistente del file RCF sullo switch.
