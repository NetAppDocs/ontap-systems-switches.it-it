...
summary: Installa NX-OS sugli switch Cisco Nexus 9332D-GX2B per nuove installazioni di sistemi AFX 1K o AFX 2K, sostituzioni di switch o ripristini delle impostazioni di fabbrica. 
---
= Installa NX-OS sullo switch Cisco Nexus 9332D-GX2B
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa NX-OS sugli switch Cisco Nexus 9332D-GX2B per nuove installazioni di sistemi AFX 1K o AFX 2K, per la sostituzione di switch o quando ripristini uno switch alle impostazioni di fabbrica.
