...
summary: Se si dispone di un ambiente cluster switchless a due nodi esistente, è possibile migrare a un ambiente cluster switchato a due nodi utilizzando gli switch Cisco Nexus 9332D-GX2B per poter scalare oltre due nodi nel cluster. 
---
...
[role="lead"]
Se si dispone di un ambiente cluster a due nodi _senza switch_, è possibile migrare a un ambiente cluster a due nodi _con switch_ utilizzando gli switch Cisco Nexus 9332D-GX2B.
...
** Consultare la  https://hwu.netapp.com["Hardware Universe"^] per tutte le versioni ONTAP supportate.


* Per la configurazione dello switch Cisco Nexus 9332D-GX2B:
+
...
** Le connessioni da nodo a nodo e da switch a switch del Nexus 9332D-GX2B utilizzano cavi Twinax o in fibra.
+
Consultare la  https://hwu.netapp.com["Hardware Universe"^] per ulteriori informazioni sul cablaggio.



* I cavi Inter-Switch Link (ISL) sono collegati alle porte 1/35 e 1/36 su entrambi gli switch 9332D-GX2B.
* La personalizzazione iniziale di entrambi gli switch 9332D-GX2B è stata completata, in modo che:
+
** Gli switch 9332D-GX2B utilizzano la versione software più recente.
...
* I nomi degli switch 9332D-GX2B2 sono cs1 e cs2.
...
Consultare  https://hwu.netapp.com["Hardware Universe"^] per informazioni sulle porte del cluster per le proprie piattaforme. Consultare link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["Quali informazioni aggiuntive mi servono per installare la mia attrezzatura che non è presente in HWU?"^] per ulteriori informazioni sui requisiti di installazione dello switch.
...
----
====
. Verificare che l'ISL e le porte fisiche sull'ISL tra i due switch 9332D-GX2B cs1 e cs2 siano attivi sulle porte 1/35 e 1/36:
+
...
----
====
. Scollegare il cavo dalla porta e0a del cluster sul nodo 1, quindi collegare e0a alla porta 1 sullo switch cs1 del cluster, utilizzando il cablaggio appropriato supportato dagli switch 9332D-GX2B.
+
IL https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe - Interruttori"^] contiene maggiori informazioni sul cablaggio.

. Scollegare il cavo dalla porta e0a del cluster sul nodo 2, quindi collegare e0a alla porta 2 sullo switch cs1 del cluster, utilizzando il cablaggio appropriato supportato dagli switch 9332D-GX2B.
...
----
====
. Scollegare il cavo dalla porta e0b del cluster sul nodo 1, quindi collegare e0b alla porta 1 sullo switch cs2 del cluster, utilizzando il cablaggio appropriato supportato dagli switch 9332D-GX2B.
. Scollegare il cavo dalla porta e0b del cluster sul nodo 2, quindi collegare e0b alla porta 2 sullo switch cs2 del cluster, utilizzando il cablaggio appropriato supportato dagli switch 9332D-GX2B.
