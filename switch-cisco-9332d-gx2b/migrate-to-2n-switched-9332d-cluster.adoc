...
** Vedere https://hwu.netapp.com["Hardware Universe"^] Per tutte le versioni di ONTAP supportate.
...
+
Vedere https://hwu.netapp.com["Hardware Universe"^] per ulteriori informazioni sul cablaggio.
...
+
https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe - Switch"^]
