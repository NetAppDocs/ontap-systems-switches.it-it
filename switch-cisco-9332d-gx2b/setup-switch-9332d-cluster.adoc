...
* link:required-documentation-9332d-cluster.html["Documentazione richiesta su switch e ONTAP"] .
...
. Controllare la versione sugli switch di rete condivisi e, se necessario, scaricare la versione del software supportata da NetApp sugli switch da https://software.cisco.com/download/home["Download del software Cisco"^] pagina.
